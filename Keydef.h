...
/* 20 */
  ...
  {0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x2c},{0,0x2d},{0,0x2e},{0,0x2f},
/* 30 */
...
/* B0 */
  {0,0x30},{0,0x31},{0,0x32},{0,0x33},{0,0x34},{0,0x35},{0,0x36},{0,0x37},
  {0,0x38},{0,0x39},{0,0x00},{0,0x00},{0,0x00},{0,0x3d},{1,0xf0},{1,0xf1},
/* C0 */
  {1,0xf2},{1,0xf3},{1,0xf4},{0,0x00},{0,0x00},{0,0x00},{1,0xfd},{0,0x00},
...
/* 100 */
  ...
  {0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},
/* 110 */
  {0,0x00},{0,0x1E},{0,0x1F},{0,0x1C},{0,0x1D},{0,0x00},{0,0x00},{0,0x00},
  {0,0xFE},{0,0x00},{1,0xF0},{1,0xF1},{1,0xF2},{1,0xF3},{1,0xF4},{1,0xF5},
/* 120 */
  {1,0xF6},{1,0xF7},{1,0xF8},{1,0xF9},{0,0x00},{0,0x00},{0,0x00},{0,0x00},
  {0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},
/* 130 */
  {0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},
  {0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},
...
/* 30 */
  ...
  {0,0x28},{0,0x29},{0,0x2a},{0,0x2b},{0,0x00},{0,0x00},{0,0x00},{0,0x00},
/* 40 */
  {0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},
  {0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},
/* 50 */
  {0,0x0b},{0,0x1d},{0,0x1e},{0,0x1c},{0,0x1f},{1,0xfc},{1,0xfc},{0,0x00},
  {0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x5f},{0,0x00},{0,0x00},{0,0x00},
/* 60 */
...
/* B0 */
  {0,0x30},{0,0x31},{0,0x32},{0,0x33},{0,0x34},{0,0x35},{0,0x36},{0,0x37},
  {0,0x38},{0,0x39},{0,0x00},{0,0x00},{0,0x00},{0,0x3d},{1,0xf5},{1,0xf6},
/* C0 */
  {1,0xf7},{1,0xf8},{1,0xf9},{0,0x00},{0,0x00},{0,0x00},{1,0xfd},{0,0x00},
  {0,0x00},{0,0x00},{0,0x12},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},
/* D0 */
  {0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},
  {0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},{0,0x00},
...
/* 50 */
  {0,0x0c},{0,0x1d},{0,0x1e},{0,0x1c},{0,0x1f},{0,0xfe},{0,0xfe},{0,0x00},
  {0,0x00},{0,0x00},{0,0x00},{0,0xdf},{0,0xfb},{0,0xf1},{0,0xed},{0,0x00},
/* 60 */
...
/* 50 */
  {0,0x0c},{0,0x1d},{0,0x1e},{0,0x1c},{0,0x1f},{0,0xfe},{0,0xfe},{0,0x00},
  {0,0x00},{0,0x00},{0,0x00},{0,0xdf},{0,0xdb},{0,0xd1},{0,0xcd},{0,0x00},
/* 60 */
